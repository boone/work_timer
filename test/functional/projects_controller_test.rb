...
class ProjectsControllerTest < ActionController::TestCase
  ...
  test "should get index" do
    get :index, params: { client_id: @project.client }
    assert_response :success
    assert_not_nil assigns(:projects)
  end

  test "should get new" do
    get :new, params: { client_id: @project.client }
    assert_response :success
  ...
  test "should show project" do
    get :show, params: { client_id: @project.client, id: @project.to_param }
    assert_response :success
    assert_not_nil assigns(:project)
  end

  test "should get edit" do
    get :edit, params: { client_id: @project.client, id: @project.to_param }
    assert_response :success
    assert_not_nil assigns(:project)
  end

  test "should update project" do
    put :update, params: { client_id: @project.client, id: @project.to_param,
  ...
  test "should destroy project" do
    assert_difference('Project.count', -1) do
      delete :destroy, params: { client_id: @project.client,
        id: @project.to_param }
    end
