...
Rails 4.1 project, used to track time worked on projects for a single user.

{<img src="https://travis-ci.org/boone/work_timer.png" />}[https://travis-ci.org/boone/work_timer]
...
you should use your own database.yml and secret_token.rb. And add your own authentication layer.
